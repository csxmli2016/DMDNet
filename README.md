...
> The proposed CelebRef-HQ dataset has been released (see below) and the code. All code and model will be available on November.
...
<div align=center>
<img src="./GithubImgs/pipeline.png" width=80%>
</div>
